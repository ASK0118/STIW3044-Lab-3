...
<body>
    ...
    <div class="w3-grid-template">
        ...
        foreach ($rows as $courses) {
            ...
            echo "<a href='courses.php?sjid=$sjid' style='text-decoration: none;'> <img class='w3-image' src='../../assets/courses/1.png'" ." style='width:100%;height:250px'></a><hr>";
    ...
    <div class="w3-container w3-row w3-margin w3-border">
        ...
        foreach ($rows as $courses) {
            ...
            <header class='w3-container w3-blue w3-center'><h5><b>$sjname</b></h5></header>";
            echo "<a href='courses.php?sjid=$sjid' style='text-decoration: none;'> <img class='w3-image' src=../../assets/courses/1.png" ." style='width:100%;height:250px'></a><hr>";
            echo "<div class='w3-container'><p>ID: $sjid<br>Name: $sjname<br>Description: $sjtype<br>Price:RM $sjprice<br>Tutor ID: $ttid<br>Session: $sjss<br>Rating: $sjrt<br></p></div>
            </div>"
